...
SECRET_KEY = 'django-insecure-x%$_6x$0104is$0x4loa$wiec*h*#lmrk!4+76+v+dn-zzj2!_'
...
from pathlib import Path
# Adicione a linha a  seguir no topo do arquivo após a importação do lib pathlib
import os
